...
use Markdown\ExtraParser;
use Markdown\Tests\FeatureTest;

class ExtraFeatureTest extends FeatureTest
{

    public function testParser()
    {
        $parser = new ExtraParser();

        $this->assertTrue($parser instanceof ExtraParser);
